...
dataset = 'hmda'
modelType = 'nb' #'lr' # 'nb' Logistic Regression or Gaussian Naive Bayes
...
class base:
        ...
        def create_historic_data(self,file_name):
                ...
                if(dataset=='hmda'):
                       ...
                       #key_profile = ['profile_median','corr_MSSubClass', 'corr_Neighborhood', 'corr_OverallQual',  'corr_YearBuilt',  'corr_ExterQual', 'corr_BsmtQual', 'corr_TotalBsmtSF',  'corr_1stFlrSF',  'corr_GrLivArea',   'corr_KitchenQual',  'corr_GarageYrBlt', 'ot_GarageYrBlt', 'corr_GarageCars',  'corr_GarageArea']
                                ...
                                for param2 in range(norm_params):
                                        ...
                                        # print("Dropping missing values ...")
                                                ...
                                                if norm_strategy[param2] == 'none':
                                                        ...
                                                        scaled_X_train = self.Log10_normalization(imputed_X_test)
                                                        norm_param = [3]
                                                elif norm_strategy[param2] == 'ma':
                                                        scaled_X_train = self.MA_normalization(imputed_X_test)
                                                        norm_param = [4]
                                                elif norm_strategy[param2] == 'mm':
