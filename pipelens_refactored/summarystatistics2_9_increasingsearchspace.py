...
if __name__ == "__main__":
    ...
    sizes = [(2,2),(3,3),(5,5),(9,9)]
    sizes.reverse()

    f = sys.stdout
    if not(os.path.exists('ERmetrics/experiment2summary_9.txt')):
      f = open('ERMetrics/experiment2summary_9.txt', 'w')
    ...
    for size in sizes:
      ...
      if 0.725 not in param.ranges[3]:
      ...
      if 0.725 not in projparam.ranges[3]:
      ...
      if 0.725 not in profile.ranges[3]:
    ...
    if not(os.path.exists('ERmetrics/experiment2summary_9.csv')):
      profiles_df.to_csv('ERmetrics/experiment2summary_9.csv')
