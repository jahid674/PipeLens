...
if __name__ == "__main__":
  #Q2 graph
  summary_df = pd.read_csv('ERmetrics/experiment2summary_8.csv')
  summary_group = summary_df.groupby('search space size')
  s_sizes = [48,64,96, 120, 200, 512]
  ...
  plt.legend()
  plt.savefig('ERfigures/injectq2_8.pdf')
  ...
  q4grid_x = [48,64,96, 120, 200, 512]
  q4grid_y = [26.0,40, 46.0, 55, 59.0, 145.0]
  for sz in s_sizes:
  ...
  plt.legend()
  plt.savefig('ERfigures/injectq4_8.pdf')
