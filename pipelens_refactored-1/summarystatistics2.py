...
if __name__ == "__main__":
    ...
    f = sys.stdout
    if not(os.path.exists('ERmetrics/experiment2summary.txt')):
      f = open('ERMetrics/experiment2summary.txt', 'w')
    ...
    if not(os.path.exists('ERmetrics/experiment2summary.csv')):
      profiles_df.to_csv('ERmetrics/experiment2summary.csv')
