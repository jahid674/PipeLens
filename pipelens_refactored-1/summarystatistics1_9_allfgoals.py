...
if __name__ == "__main__":
    ...
    f = sys.stdout
    if not(os.path.exists('ERmetrics/experiment1summary_9.txt')):
      f = open('ERMetrics/experiment1summary_9.txt', 'w')
    ...
    if not(os.path.exists('ERmetrics/experiment1summary_9.csv')):
      profiles_df.to_csv('ERmetrics/experiment1summary_9.csv')
