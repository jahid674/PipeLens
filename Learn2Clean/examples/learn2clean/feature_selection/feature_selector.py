...
class Feature_selector():
    ...
    * verbose: Boolean,  default = 'False' otherwise display information
    ...
    def transform(self):
        ...
        print(self.dataset['test'].shape[1], "features ")
        print(not isinstance(self.dataset['target'], dict))
        ...
        elif (self.exclude not in self.dataset['test'].columns.values):
