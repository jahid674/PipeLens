...
def constraint_discovery(dataset, file_name):
    ...
    fn = '/Users/apple/Documents/code/OptimizingPipeline/Learn2Clean/save/' + file_name + '_constraints.tdda'
    with open(fn, 'w') as f:
...
def pattern_discovery(dataset, file_name):
    ...
    fn = '/Users/apple/Documents/code/OptimizingPipeline/Learn2Clean/save/'+file_name + '_patterns.txt'
    # file = open(fn,"w")
...
class Consistency_checker():
    ...
    * threshold: float, default =  None
    ...
    def CC_constraint_checking(self, dataset, file_name, verbose):
        ...
        d = detect_df(dataset,  '/Users/apple/Documents/code/OptimizingPipeline/Learn2Clean/save/'+file_name + '_constraints.tdda')
        ...
        v = verify_df(dataset, '/Users/apple/Documents/code/OptimizingPipeline/Learn2Clean/save/'+file_name+'_constraints.tdda')
